...
export class AppComponent {
  ...
  constructor() {
    ...
    this.dadosAlunos = [
      ...
      { 'id': 5, 'nome': 'Jeremiah Hadwen', 'fone': '(345) 6582965', 'email': 'jhadwen4@vkontakte.ru', 'sexo': 'Masculino', 'pais': 'Mongolia' },
      { 'id': 6, 'nome': 'Romilada Andrade', 'fone': '(659) 9557733', 'email': 'romildaandr@thetimes.com', 'sexo': 'Masculino', 'pais': 'Belgica' },
      { 'id': 7, 'nome': 'Ramirez Gonzales', 'fone': '(864) 2101861', 'email': 'ramirezgonza6@yellowbook.com', 'sexo': 'Masculino', 'pais': 'Peru' },
      ...
      { 'id': 10, 'nome': 'Bernardo Guzman', 'fone': '(673) 5170425', 'email': 'bernardoguz@google.co.jp', 'sexo': 'Feminino', 'pais': 'Uruguai' },
      { 'id': 11, 'nome': 'Darelle Rowlands', 'fone': '(978) 8885907', 'email': 'drowlandsa@slate.com', 'sexo': 'Feminino', 'pais': 'Indonesia' },
      ...
      { 'id': 18, 'nome': 'Manoel Bueno Soares', 'fone': '(213) 5730967', 'email': 'manuelbsoares@yahoo.com', 'sexo': 'Masculino', 'pais': 'Portugal' },
